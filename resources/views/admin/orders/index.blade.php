...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        ...
        <small class="text-muted">
            ...
            @else Online and Cash on Delivery orders in one place @endif
        </small>
    </div>
</div>
...
<script>
    $(function () {
        ...
        const initialPaymentMethod = new URLSearchParams(window.location.search).get('payment_method') || '';
        $('#filterPaymentMethod').val(initialPaymentMethod);
